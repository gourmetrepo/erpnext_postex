...
def make_material_request(source_name, target_doc=None):
	...
	for i in dn.items:
		if i.item_code in i_c:
			...
			wh = frappe.db.get_value('Item Default',{"parent":i.item_code,"default_warehouse":["is","set"],"company":dn.company},'default_warehouse')
...
def make_delivery_note(source_name, target_doc=None, skip_item_mapping=False):
	...
	target_doc = get_mapped_doc("Sales Order", source_name, mapper, target_doc, set_missing_values,ignore_permissions=True)
